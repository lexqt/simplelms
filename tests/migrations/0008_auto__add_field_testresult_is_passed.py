...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TestResult.is_passed'
        db.add_column('tests_testresult', 'is_passed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TestResult.is_passed'
        db.delete_column('tests_testresult', 'is_passed')
