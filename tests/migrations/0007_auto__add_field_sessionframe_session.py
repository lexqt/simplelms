...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SessionFrame.session'
        db.add_column('tests_sessionframe', 'session', self.gf('django.db.models.fields.related.ForeignKey')(related_name='frames', null=True, to=orm['tests.Session']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SessionFrame.session'
        db.delete_column('tests_sessionframe', 'session_id')
