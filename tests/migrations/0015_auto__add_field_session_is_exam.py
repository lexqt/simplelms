...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Session.is_exam'
        db.add_column('tests_session', 'is_exam', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Session.is_exam'
        db.delete_column('tests_session', 'is_exam')
