...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SessionFrame.frame'
        db.delete_column('tests_sessionframe', 'frame_id')

        # Adding field 'SessionFrame.scheme'
        db.add_column('tests_sessionframe', 'scheme', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'SessionFrame.frame_id'
        db.add_column('tests_sessionframe', 'frame_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'SessionFrame.frame'
        raise RuntimeError("Cannot reverse this migration. 'SessionFrame.frame' and its values cannot be restored.")

        # Deleting field 'SessionFrame.scheme'
        db.delete_column('tests_sessionframe', 'scheme')

        # Deleting field 'SessionFrame.frame_id'
        db.delete_column('tests_sessionframe', 'frame_id')
