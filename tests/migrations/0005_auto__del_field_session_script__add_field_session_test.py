...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Session.script'
        db.delete_column('tests_session', 'script_id')

        # Adding field 'Session.test'
        db.add_column('tests_session', 'test', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='+', to=orm['tests.Test']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Session.script'
        raise RuntimeError("Cannot reverse this migration. 'Session.script' and its values cannot be restored.")
    ...
    models = {
        ...
        'tests.session': {
            ...
            'test': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['tests.Test']"}),
