...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SessionFrame.next_sframe'
        db.alter_column('tests_sessionframe', 'next_sframe_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['tests.SessionFrame']))

        # Adding unique constraint on 'SessionFrame', fields ['next_sframe']
        db.create_unique('tests_sessionframe', ['next_sframe_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SessionFrame', fields ['next_sframe']
        db.delete_unique('tests_sessionframe', ['next_sframe_id'])

        # Changing field 'SessionFrame.next_sframe'
        db.alter_column('tests_sessionframe', 'next_sframe_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tests.SessionFrame']))
