...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Session.rating_threshold'
        db.add_column('tests_session', 'rating_threshold', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Session.rating_threshold'
        db.delete_column('tests_session', 'rating_threshold')
    ...
    models = {
        ...
        'tests.sessionframe': {
            ...
            'next_sframe': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'previous'", 'null': 'True', 'to': "orm['tests.SessionFrame']"}),
