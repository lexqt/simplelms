...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SessionFrame.session'
        db.alter_column('tests_sessionframe', 'session_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['tests.Session']))


    def backwards(self, orm):
        
        # Changing field 'SessionFrame.session'
        db.alter_column('tests_sessionframe', 'session_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tests.Session']))
