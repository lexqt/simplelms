...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'TestResult', fields ['user']
        db.delete_unique('tests_testresult', ['user_id'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'TestResult', fields ['user']
        db.create_unique('tests_testresult', ['user_id'])
