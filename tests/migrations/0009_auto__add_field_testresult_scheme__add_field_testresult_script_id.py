...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TestResult.scheme'
        db.add_column('tests_testresult', 'scheme', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'TestResult.script_id'
        db.add_column('tests_testresult', 'script_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TestResult.scheme'
        db.delete_column('tests_testresult', 'scheme')

        # Deleting field 'TestResult.script_id'
        db.delete_column('tests_testresult', 'script_id')
