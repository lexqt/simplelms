...
from .views import CourseListView, MyCoursesListView, ApplicationsOverviewListView, CourseApplicationsListView, CourseView

urlpatterns = patterns('courses.views',
    url(r'^list$', CourseListView.as_view(), name='list'),
    url(r'^my$', MyCoursesListView.as_view(), name='my_courses'),
