...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Enrollment', fields ['course', 'user']
        db.create_unique('courses_enrollment', ['course_id', 'user_id'])

        # Adding unique constraint on 'Application', fields ['course', 'user']
        db.create_unique('courses_application', ['course_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Application', fields ['course', 'user']
        db.delete_unique('courses_application', ['course_id', 'user_id'])

        # Removing unique constraint on 'Enrollment', fields ['course', 'user']
        db.delete_unique('courses_enrollment', ['course_id', 'user_id'])
    ...
    models = {
        ...
        'courses.application': {
            'Meta': {'unique_together': "(('course', 'user'),)", 'object_name': 'Application'},
            'course': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'applications_submitted'", 'to': "orm['courses.Course']"}),
            'date_submitted': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'applications_submitted'", 'to': "orm['auth.User']"})
        },
        'courses.certificate': {
