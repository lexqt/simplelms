...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.date_created'
        db.add_column('courses_course', 'date_created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.date(2011, 10, 23), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.date_created'
        db.delete_column('courses_course', 'date_created')
