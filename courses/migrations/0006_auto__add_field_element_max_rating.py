...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Element.max_rating'
        db.add_column('courses_element', 'max_rating', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Element.max_rating'
        db.delete_column('courses_element', 'max_rating')
